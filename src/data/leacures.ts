const lectures = [
  ...
  {
    id: 4,
    title: "Sexualitet, relationer och samtycke, undervisning i Anpassad skola",
    slug: "sexualitet-relationer-och-samtycke-undervisning-i-anpassad-skola",
    imgUrl:
      "https://cdn.pixabay.com/photo/2023/09/16/21/31/girl-8257551_1280.jpg",
    description:
      "Kunskap kring funktionsnedsättningar/diagnoser. Sexualitet, relationer och samtycke. Attityder och förhållningssätt. Ungdomarnas aktivitet på internet. Föreläsningen utgår från teorier och forskning och tillhandahåller metoder och material som finns att tillgå och som vi skapar tillsammans.",
  },
  {
    id: 5,

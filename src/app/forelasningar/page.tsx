      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {lectures.map((lecture) => {
            const titleLines =
              lecture.title.length > 50 ? 3 : lecture.title.length > 30 ? 2 : 1;
                ...
                >
                  <Card className="flex h-full flex-col hover:cursor-pointer">
                    ...
                    <CardContent className="flex flex-1 flex-col p-6">
                      <CardTitle className="mb-2 flex-none text-xl leading-tight [-webkit-box-orient:vertical] [-webkit-line-clamp:3] [display:-webkit-box]">
                        {lecture.title}
                      </CardTitle>
                      <CardDescription
                        className="overflow-hidden text-ellipsis [-webkit-box-orient:vertical] [-webkit-line-clamp:var(--desc-lines)] [display:-webkit-box]"
                        style={
                          {
                            "--desc-lines":
                              lecture.title.length > 40
                                ? 3
                                : lecture.title.length > 25
                                  ? 4
                                  : 5,
                            maxHeight:
                              lecture.title.length > 40 ? "4.5rem" : "7.5rem",

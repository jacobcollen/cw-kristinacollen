...
function Navbar() {
  ...
  // Kontrollera aktiv sektion (fixar "/" buggen)
      ...
      <div className="flex items-center gap-7">
        {[
          ...
          >
            ...
            <Link
              href={href}
              className={`relative text-xl text-gray-300 transition-colors hover:text-white ${isSectionActive(href) ? "font-semibold text-white" : ""} ${
